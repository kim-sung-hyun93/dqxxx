...
public class MethodTest {
	...
	public static void display(String name, String addr
			, int age) { //person class의 정보를 출력
	...
	//타입이 다른 여러 개의 데이터를 리턴하고 싶은 경우 배열로 리턴할 수 없으므로 리턴하고 싶은 값을 갖고 있는 객체를 생성해서 리턴한다.
	public static Student getInfo() {
		//Student의 모든 정보를 리턴
		return new Student("장동건", 90, 100, 50, 78); // << 예를들어서!
	}
}
